import { getUsers, getDoctors, saveUser, saveDoctor } from './storage';
...
export function seedData() {
  ...
  [adminUser, doctorUser1, doctorUser2, doctorUser3, patientUser].forEach(saveUser);
  ...
  [doctor1, doctor2, doctor3].forEach(saveDoctor);
}
